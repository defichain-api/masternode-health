...
return [
     ...
     */
    'title' => 'DeFiChain Masternode Health',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'The following endpoints are used for setup a server and how to fetch the information for it. You need to use the bash script installed as cron on your server.',

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => 'https://defichain-masternode-health.com',
