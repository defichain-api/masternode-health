...
class ServerStatController
{
     ...
     * @bodyParam connection_count integer required Count of the current fullnode connections. Example: 91
     * @bodyParam logsize float required Size of the debug.log file in MB. Example: 13.21
     * @bodyParam config_checksum string required MD5 Hash of the defi.conf file. Example: a3cca2b2aa1e3b5b3b5aad99a8529074
